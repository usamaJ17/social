<div id="cdn-browser-modal" class="modal fade">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div id="cdn-browser" data-prefixed="" class="cdn-browser d-flex flex-column" v-cloak :class="{is_loading:isLoading}">
                <div class="files-nav flex-shrink-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-right">
                            ...
                            <img src="https://contrafinder.com/public/images/loading.gif" style="height:30px;"   v-show="isLoading" />
