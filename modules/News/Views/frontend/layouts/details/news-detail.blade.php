						...
						<div class="row">
								...
								<div class="pag_prev">
									<div class="detls">
										@if(!empty($previous->slug))
											<a href="{{route('news.detail',['slug'=>$previous->slug])}}">
												<h5 class="text-thm"><span class="fa fa-angle-left mr5"></span> {{__('Previous Post')}}</h5>
							...
							<div class="col-sm-6 col-lg-6">
								<div class="pag_next text-right">
									<div class="detls">
										@if(!empty($next->slug))
											<a href="{{route('news.detail',['slug'=>$next->slug])}}">
												<h5 class="text-thm">{{__('Next Post')}} <span class="fa fa-angle-right ml5"></span></h5>
