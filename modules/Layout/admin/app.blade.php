...
<head>
    ...
    <style>
        .admin_module_news, .admin_module_page, .https:__contrafinder.appstown.co_admin_module_location{			display:none;		}
        .has-children .admin_module_property{			display:none;		}
    </style>

    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Contrafinder'}}</title>
...
<link href="https://contrafinder.com/public//libs/font-awesome/css/font-awesome.css" rel="stylesheet">
