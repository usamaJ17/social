<?php $listGallery = getproject_Gallery($project_details->id); ?>
@if ($listGallery)
                    ...
                    @if($key <= 10)
                        <div class="col-6 col-md-6 col-lg-4">
                            <div class="gallery_item">
                                ...
                                @if($key >= 12)
                                    <div class="gallery_overlay style2 listing_single_v1"><a class="icon popup-img" href="{{ $val['large'] }}"><span class="fz14">+{{ count($listGallery) - 13 }}</span></a></div>
                                @else
