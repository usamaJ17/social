            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Project name" name="project_name" value="{{$row_->project_name}}">
                        <input type="hidden" name="project_id" value="{{$row_->id}}">
                    </div>
                     <input type="hidden" class="form-control"  name="project_description" value="{{$row_->project_description}}" required>
                    <div class="form-group">
                        <label for="Project address">Project address</label>
                        <input type="text" class="form-control" id="Project address" name="address" value="{{$row_->project_location}}">
                    </div>
                    <div class="form-group">
                        <label for="Project Completion year">Project Completion year</label>
                        <input type="text" class="form-control" id="Project Completion year" name="completion_year" value="{{$row_->completion_year}}">
                    </div>
                    <div class="form-group">
                        <label for="pwd"><small>Cost Range</small></label>
                        <select class="form-control" name="cost">
                            <option <?=($row_->project_cost=="AED_0-100K" ? "selected" : "")?> value="AED_0-100K"> AED 0 - 100K  </option>
                            <option <?=($row_->project_cost=="AED_100K-500K" ? "selected" : "")?> value="AED_100K-500K"> AED 100K - 500K  </option>
                            <option <?=($row_->project_cost=="AED_500K-800K" ? "selected" : "")?> value="AED_500K-800K"> AED 500K - 800K  </option>
                            <option <?=($row_->project_cost=="AED_800K-3M" ? "selected" : "")?> value="AED_800K-3M"> AED 800K - 3M  </option>
                            <option <?=($row_->project_cost=="AED_3M-5M" ? "selected" : "")?> value="AED_3M-5M"> AED 3M - 5M  </option>
                            <option <?=($row_->project_cost=="Over_AED_5M" ? "selected" : "")?> value="Over_AED_5M"> Over AED 5M    </option>
                        </select>
                    </div>
                  <div class="form-group">
                        <label>Category</label>
                        <select class="form-control" name="category">
                            <option <?=($row_->category=="Fitout_Contractor" ? "selected" : "")?> value="Fitout_Contractor"> Fitout Contractor</option>
                            <option <?=($row_->category=="Design_&_Build" ? "selected" : "")?> value="Design_&_Build"> Design & Build</option>
                            <option <?=($row_->category=="FF&E" ? "selected" : "")?> value="FF&E"> FF&E</option>
                            <option <?=($row_->category=="Interior_Design/Decoration" ? "selected" : "")?> value="Interior_Design/Decoration"> Interior Design/Decoration</option>
                            <option <?=($row_->category=="Remodeling" ? "selected" : "")?> value="Remodeling"> Remodeling</option>
                            <option <?=($row_->category=="Renovation" ? "selected" : "")?> value="Renovation"> Renovation</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="type">
                            <option>Type</option>
                            <option <?=($row_->type=="Restaurant/Food_&_Beverage" ? "selected" : "")?> value="Restaurant/Food_&_Beverage">Restaurant/Food & Beverage</option>
                            <option <?=($row_->type=="Retail" ? "selected" : "")?> value="Retail"> Retail</option>
                            <option <?=($row_->type=="Commercial_Offices" ? "selected" : "")?> value="Commercial_Offices"> Commercial Offices</option>
                            <option <?=($row_->type=="Industrial" ? "selected" : "")?> value="Industrial">  Industrial</option>
                            <option <?=($row_->type=="Healthcare_facilities" ? "selected" : "")?> value="Healthcare_facilities">  Healthcare facilities</option>
                            <option <?=($row_->type=="Hotels/Resorts" ? "selected" : "")?> value="Hotels/Resorts">  Hotels/Resorts</option>
                            <option <?=($row_->type=="Showroom/Gallery" ? "selected" : "")?> value="Showroom/Gallery">  Showroom/Gallery</option>
                        </select>
                    </div>
                ...
                <div class="panel-body">
                    {!! \Modules\Media\Helpers\FileHelper::fieldGalleryUpload('banner_images',$row_->project_photos, "proj_img_". $row_->unique_id) !!}
                </div>
            </div>
...
Contrafinder’s <a href="https://contrafinder.com/page/terms-of-use" style="color:#30c21c;">Terms of use</a></p>
                    ...
                    padding: 15px;" type="submit" class="btn btn-log btn-block btn-thm form-submit">Update Project</button>
                    </form>
                    <!-- Modal -->
