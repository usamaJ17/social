        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <input type="text" name="property_page_search_sub_title" value="{{setting_item_with_lang('property_page_search_sub_title',request()->query('lang'))}}" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="" >{{__("Background search page")}}</label>
                    <div class="form-controls form-group-image">
                        {!! \Modules\Media\Helpers\FileHelper::fieldUpload('property_page_search_background',$settings['property_page_search_background'] ?? "") !!}
                    </div>
                </div>
                @if(is_default_lang())
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select  name="property_page_search_layout" class="form-control">
                                ...
                                <option {{setting_item('property_page_search_layout') == 'v5' ? 'selected="selected"' : ''}} value="v5">{{__('V5')}}</option>
                                <option {{setting_item('property_page_search_layout') == 'map1' ? 'selected="selected"' : ''}} value="map1">{{__('Map V1')}}</option>
                                <option {{setting_item('property_page_search_layout') == 'half_map_right' ? 'selected="selected"' : ''}} value="half_map_right">{{__('Half Map Right')}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select name="property_page_single_layout" class="form-control">
                                ...
                                <option {{setting_item('property_page_single_layout') == 3 ? 'selected="selected"' :
                                ''}} value="3">{{__('V3')}}</option>
                            </select>
                        </div>
                    </div>
                @endif
            ...
            <div class="panel-body">
                <div class="form-group">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#form_search">{{__("Form Search Fields")}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#form_search_sidebar">{{__("Sidebar Search Fields")}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#form_search_map">{{__("Map Search Fields")}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#form_search_mobile">{{__("Mobile Search Fields")}}</a>
                        </li>
                    </ul>
                    <div class="tab-content" >
                        <div class="tab-pane active" id="form_search">
                            @include('Property::admin.settings.form-search')
                        </div>
                        <div class="tab-pane" id="form_search_mobile">
                            @include('Property::admin.settings.form-search-mobile')
                        </div>
                        <div class="tab-pane" id="form_search_sidebar">
                            @include('Property::admin.settings.form-search-sidebar')
                        </div>
                        <div class="tab-pane" id="form_search_map">
