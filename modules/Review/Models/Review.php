...
class Review extends BaseModel
{
    ...
    public static function getTotalViewAndRateAvg($objectId, $objectModel)
    {
	    ...
	    /*$list_score = Cache::rememberForever('review_'.$objectModel.'_' . $objectId, function () use ($objectId, $objectModel) {
			...
			$dataReview = self::selectRaw(" AVG(rate_number) as sbc_total , COUNT(id) as total_review ")->where('object_id', $objectId)->where('object_model', $objectModel)->whereNull('deleted_at')->where("status", "approved")->first();
