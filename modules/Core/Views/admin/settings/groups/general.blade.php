            ...
            <div class="panel-body">
                @if(is_default_lang())
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" @if(setting_item('enable_rtl') ?? '' == 1) checked @endif name="enable_rtl" value="1">{{__('Enable')}}</label>
                        </div>
                    </div>
                @endif
            </div>
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__('Enable maintenance mode')}}</h3>
        <p class="form-group-desc">{{__('Set up maintenance mode for your website')}}</p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <label><input type="checkbox"
                            ...
                            @if(setting_item('enable_maintenance_mode') ?? '' == 1) checked @endif name="enable_maintenance_mode" value="1">
                        {{__('Enable')}}</label>
                    </div>
                </div>
                <div class="form-group" data-condition="enable_maintenance_mode:is(1)">
                    <label>{{__("Page title")}}</label>
                    <div class="form-controls">
                        <input type="text" class="form-control" name="maintenance_mode_title" value="{{setting_item_with_lang('maintenance_mode_title',request()->query('lang'), 'We’re coming soon.')}}">
                    </div>
                </div>
                <div class="form-group" data-condition="enable_maintenance_mode:is(1)">
                    <label>{{__("Page desc")}}</label>
                    <div class="form-controls">
                        <textarea name="maintenance_mode_desc" class="form-control" cols="30" rows="7">{{setting_item_with_lang('maintenance_mode_desc',request()->query('lang'), 'Our website is under construction. We’ll be here soon with our new awesome site, subscribe to be notified.')}}</textarea>
                    </div>
                </div>
                @if(is_default_lang())
                    <div class="form-group" data-condition="enable_maintenance_mode:is(1)">
                        <label>{{__("Coming day")}}</label>
                        <div class="form-controls">
                            <input type="datetime-local" class="form-control" name="maintenance_mode_time" value="{{setting_item('maintenance_mode_time', $coming_soon_date)}}">
                        </div>
                    </div>
                    <div class="form-group" data-condition="enable_maintenance_mode:is(1)">
                        <label>{{__("Image Uploader")}}</label>
                        <div class="form-controls form-group-image">
                            {!! \Modules\Media\Helpers\FileHelper::fieldUpload('maintenance_mode_img',setting_item('maintenance_mode_img')) !!}
                        </div>
                    </div>
                @endif
            </div>
