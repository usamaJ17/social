            ...
            <div class="row">
                <div class="col-md-11">
                    ...
                    <div class="form-group">
                        <label for="Project name">Project name kk</label>
                        <input type="text" class="form-control" id="Project name" name="project_name" value="{{$row->project_name}}">
                        <input type="hidden" name="project_id" value="{{$row->id}}">
                    </div>
                    <div class="form-group">
                        <label for="Project address">Project address</label>
                        <input type="text" class="form-control" id="Project address" name="address" value="{{$row->project_location}}">
                    </div>
                    <div class="form-group">
                        <label for="Project Completion year">Project Completion year</label>
                        <input type="text" class="form-control" id="Project Completion year" name="completion_year" value="{{$row->completion_year}}">
                    </div>
                    <div class="form-group">
                        <label for="pwd"><small>Cost Range</small></label>
                        <select class="form-control" name="cost">
                            <option value="{{$row->project_cost}}"> AED 0 - 100K  </option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="type">
                            ...
                            <option value="3">  Office Space (Class A)k jj</option>
                            <option value="4">  Office Space (Class B)jj</option>
