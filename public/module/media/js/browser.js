    ...
    window.uploaderModal = new Vue({
        ...
        methods: {
            ...
            reloadLists() {
                ...
                me.isLoading = true;
                $.ajax({
                    url: bookingCore.url + "/admin/module/media/getLists?prefixed=" + file_uploader_prefixed,
                    type: "POST",
                    data: { file_type: this.uploadConfigs.file_type, page: this.filter.page, s: this.filter.s },
                    dataType: "json",
            ...
            upload(files) {
                ...
                for (var i = 0; i < files.length; i++) {
                    ...
                    d.append("prefixed", file_uploader_prefixed);
                    me.isLoading = true;
                    $.ajax({
