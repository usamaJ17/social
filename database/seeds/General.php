...
<a href="mailto:contact@contrafinder.com">contact@contrafinder.com</a>',
                    'group' => "general",
                ],
                [
                    'name'  => 'footer_text_left',
                    'val'   => '<div class="copyright-widget mt10 mb15-767">
						<p>Copyright © 2021 by Contrafinder</p>
					</div>',
                    'group' => "general",
                ],
                [
...
<h2>Contacting us</h2>
<p>If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to individual rights and your Personal Information, you may do so via the <a target="_blank" rel="nofollow" href="http://dev.contrafinder.org/contact">contact form</a></p>
...
素晴らしいサイト、通知を購読してください。",
        ...
        DB::table('bc_settings')->insert([
                ...
                [
                    'name'  => "email_header",
                    'val'   => '<h1 class="site-title" style="text-align: center">Contrafinder</h1>',
                    'group' => "general",
                ],
                [
                    'name'  => "email_footer",
                    'val'   => '<p class="" style="text-align: center">&copy; 2021 Contrafinder. All rights reserved</p>',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    <p>Thank you for signing up with Contrafinder! We hope you enjoy your time with us.</p>
                    <p>Regards,</p>
                    <p>Contrafinder</p>',
                    'group' => "user",
                ],
        ...
        DB::table('bc_settings')->insert([
                ...
                [
                    ...
                    'val'   => "<p><span style=\"font-size: 14pt;\"><strong>Contrafinder Company</strong></span></p>
                                <p>Ha Noi, Viet Nam</p>
                                <p>www.contrafinder.org</p>",
                    'group' => "booking",
                ],
            ]);
            DB::table('bc_settings')->insert(
